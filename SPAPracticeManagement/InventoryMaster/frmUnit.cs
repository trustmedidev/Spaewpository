...
{
    public partial class frmUnit : InventoryDashboard
    {
        #region === Variables
        Boolean falag = true;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (ValidateForm())
            {
                int x = objUnitDAL.Insert(txtName.Text.ToString(), GlobalCL.UserCD);
                if (x > 0)
                {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateForm())
            {
                ...
                int x = objUnitDAL.Update(bId, txtName.Text.ToString(), IsActiveYN);
                if (x > 0)
                {
